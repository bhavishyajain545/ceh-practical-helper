...
```
Pre-requisites for Q081:
1. Same as Q080 + DVWA security=low with valid PHPSESSID.
2. Burp running and proxying Firefox on Parrot.

Report back: "Lab ready for Q081 — DVWA proxied through Burp, security=low session ready".
```
